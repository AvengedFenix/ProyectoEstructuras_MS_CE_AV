...
public class TDAGrafo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        CD.setAttribute("weight", 2); // le seteas el atributo weight
        CD.setAttribute("ui.label", 2); //Lo imprime
        ...
        DE.setAttribute("weight", 2); // le seteas el atributo weight
        DE.setAttribute("ui.label", 2); //Lo imprime
        ...
        EF.setAttribute("weight", 2); // le seteas el atributo weight
        EF.setAttribute("ui.label", 2); //Lo imprime
        ...
        AF.setAttribute("weight", 2); // le seteas el atributo weight
        AF.setAttribute("ui.label", 2); //Lo imprime
        ...
        GA.setAttribute("weight", 2); // le seteas el atributo weight
        GA.setAttribute("ui.label", 2); //Lo imprime

        graph.addEdge("GD", "G", "D", true);

        Edge GD = graph.getEdge("GD");
        GD.setAttribute("ui.label", 2); //Lo imprime
        ...
        EG.setAttribute("weight", 2); // le seteas el atributo weight
        EG.setAttribute("ui.label", 2); //Lo imprime

        graph.addEdge("GF", "G", "F", true);
        //Node f = graph.getNode("C");
        //a.addAttribute("ui.label", "C"); //Para que salga el nombre del vertice
        Edge GF = graph.getEdge("GF");
        GF.setAttribute("weight", 2); // le seteas el atributo weight
        GF.setAttribute("ui.label", 2); //Lo imprime

        graph.addEdge("BG", "B", "G", true);
        //  Node b = graph.getNode("C");
        //a.addAttribute("ui.label", "C"); //Para que salga el nombre del vertice
        Edge BG = graph.getEdge("BG");
        BG.setAttribute("weight", 2); // le seteas el atributo weight
        BG.setAttribute("ui.label", 2); //Lo imprime

        graph.addEdge("CG", "C", "G", true);
        //   Node c = graph.getNode("C");
        //a.addAttribute("ui.label", "C"); //Para que salga el nombre del vertice
        Edge CG = graph.getEdge("CG");
        CG.setAttribute("weight", 2); // le seteas el atributo weight
        CG.setAttribute("ui.label", 2); //Lo imprime
